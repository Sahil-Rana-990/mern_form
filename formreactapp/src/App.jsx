...
function App() { 
  ...
  const changeUserData=async (e)=>{
    ...
    if(name==="image"){
      ...
      const result=await axios.post("http://localhost:5000/api/uploads",formdata,{
        headers:{
  ...
  const PassDataToBackend=async ()=>{
    ...
    if(username=="" || password== "" ||image===""){
      ...
      const res=await axios.post("http://localhost:5000/api/uploadData",{username,password,image},{
        headers:{
